...
keepalive_tolerance_ping_ack_timeout(_) ->
	...
	receive
		{gun_down, Pid, http2, {error, {connection_error, protocol_error,
...
do_ping_ack_loop_fun() ->
	%% Receive ping, sync with parant, send ping ack, loop.
