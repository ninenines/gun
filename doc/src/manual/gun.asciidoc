...
transform_header_name => fun((HeaderName1 :: binary()) -> HeaderName2 :: binary()) | undefined::
	...
	re-case header names in the event that the server considers
	header name case to be significant.
