...
include::migrating_from_2.5.asciidoc[Migrating from Gun 2.5 to 2.6]

include::migrating_from_2.4.asciidoc[Migrating from Gun 2.4 to 2.5]

include::migrating_from_2.3.asciidoc[Migrating from Gun 2.3 to 2.4]

include::migrating_from_2.2.asciidoc[Migrating from Gun 2.2 to 2.3]
