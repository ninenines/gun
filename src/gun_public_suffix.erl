...
m(S = [<<"c">>,<<"la">>]) -> e(S);
m(S = [<<"certmgr">>,<<"org">>]) -> e(S);
m(S = [<<"xenapponazure">>,<<"com">>]) -> e(S);
m(S = [<<"discourse">>,<<"group">>]) -> e(S);
m(S = [<<"discourse">>,<<"team">>]) -> e(S);
m(S = [<<"virtueeldomein">>,<<"nl">>]) -> e(S);
